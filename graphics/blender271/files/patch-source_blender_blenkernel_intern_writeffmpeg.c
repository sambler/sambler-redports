--- source/blender/blenkernel/intern/writeffmpeg.c.orig	2017-01-14 07:09:39 UTC
+++ source/blender/blenkernel/intern/writeffmpeg.c
@@ -111,412 +111,412 @@ static void ffmpeg_set_expert_options(Re
...
@@ -524,505 +524,505 @@ static void set_ffmpeg_properties(Render
...
+    avcodec_flush_buffers(video_stream->codec);
 ...
 /* **********************************************************************
@@ -1032,95 +1032,95 @@ static void flush_ffmpeg(void)
...
@@ -1128,518 +1128,518 @@ static void end_ffmpeg_impl(int is_autos
 #ifdef WITH_AUDASPACE
