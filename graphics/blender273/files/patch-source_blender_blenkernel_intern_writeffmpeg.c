--- source/blender/blenkernel/intern/writeffmpeg.c.orig	2015-01-21 23:01:24 UTC
...
@@ -598,23 +598,23 @@ static AVStream *alloc_video_stream(Rend
...
@@ -652,7 +652,7 @@ static AVStream *alloc_video_stream(Rend
