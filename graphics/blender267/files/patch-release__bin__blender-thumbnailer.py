--- release/bin/blender-thumbnailer.py.orig	2015-07-07 04:18:29 UTC
...
+   gconftool --type string --set /desktop/gnome/thumbnailers/application@x-blender/command "blender-thumbnailer-267.py %u %o"
 """
