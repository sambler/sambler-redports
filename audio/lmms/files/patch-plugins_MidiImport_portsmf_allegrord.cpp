--- plugins/MidiImport/portsmf/allegrord.cpp.orig	2015-03-08 02:47:14 UTC
+++ plugins/MidiImport/portsmf/allegrord.cpp
@@ -109,19 +109,19 @@ Alg_parameters_ptr Alg_reader::process_a
     if (attributes) {
...
@@ -210,56 +210,56 @@ bool Alg_reader::parse()
                 }
                 if (first == 'V') {
                     if (voice_flag) {
...
+                        parse_error(field, 0, (char *)"Dur specified twice");
                         ...
                         field.insert(0, 1, 'U');
@@ -268,7 +268,7 @@ bool Alg_reader::parse()
                     }
...
+                        parse_error(field, 0, (char *)"Pitch specified twice");
                         ...
                         // prepend 'P' to field
                         field.insert(0, 1, 'P');
@@ -283,7 +283,7 @@ bool Alg_reader::parse()
...
+                    parse_error(field, 0, (char *)"Unknown field");
                 ...
                 if (error_flag) {
@@ -404,7 +404,7 @@ bool Alg_reader::parse()
...
@@ -431,7 +431,7 @@ long Alg_reader::parse_chan(string &fiel
...
@@ -472,7 +472,7 @@ int Alg_reader::find_real_in(string &fie
...
@@ -501,8 +501,8 @@ double duration_lookup[] = { 0.25, 0.5, 
...
+    const char *durs = (char *)"SIQHW";
     ...
     int last;
     double dur;
@@ -554,7 +554,7 @@ double Alg_reader::parse_after_dur(doubl
...
@@ -594,8 +594,8 @@ int key_lookup[] = {21, 23, 12, 14, 16, 
 //
...
@@ -629,7 +629,7 @@ long Alg_reader::parse_after_key(int key
...
@@ -654,7 +654,7 @@ bool Alg_reader::parse_attribute(string 
...
@@ -706,7 +706,7 @@ bool Alg_reader::parse_val(Alg_parameter
...
+                parse_error(s, pos, (char *)"Unexpected char in number");
             ...
             pos = pos + 1;
@@ -727,7 +727,7 @@ bool Alg_reader::parse_val(Alg_parameter
             }
         }
     } else {
